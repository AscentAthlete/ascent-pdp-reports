...
class BlastConnector:
    ...
    def configured(self):
        ...
        return ok, "API configured" if ok else "Needs Blast API access"
    ...
    def fetch_athlete_window(self, athlete_name, start_date, end_date):
        ...
        return {
            ...
            "metrics": {},
            "raw": raw,
            "mapping_note": "Map Blast response fields after vendor API documentation is supplied."
        }
